	...
	<div class="container">
		<table class="table table-bordered" id="upboardTable">
			...
			<tbody>
				...
				--%>
				<c:forEach var="list" items="${boardList}" varStatus="listNum">
					<tr>
						<td>${page.totalRecord - ((page.nowPage - 1) * page.numPerPage + listNum.index)}</td>
						<td><a href="boardDetail?num=${list.num}">
							<img src ="${rPath}/imgfile/${list.imglist[0]}"
			...
			<tfoot>
				...
				<tr>
					<td colspan="6" style="text-align: right;">
						...
						onclick="location='boardForm'">글작성</button>
					</td>
				</tr>
			</tfoot>
		</table>
