...
<script src="<%=request.getContextPath()%>/resources/js/ajaxdemo1.js"></script>
<style>
a {
	...
	<header class="text-white text-center">
		<div class="d-flex flex-row-reverse mybgColor">
			...
			<div class="p-2 bg-primary">
				<a href="#" class="nav-link text-white" id="item3">회원가입</a>
			</div>
		</div>
		<!-- Carousel -->
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item dropdown"><a
					...
					<ul class="dropdown-menu">
						<li><a class="dropdown-item" href="fboardList">FreeBoard</a></li>
						<li><a class="dropdown-item" href="ajaxBoard">AjaxBoard</a></li>
						<li><a class="dropdown-item" href="uplist">uploadBoard</a></li>
					</ul>
				</li>
